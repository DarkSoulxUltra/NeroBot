...
from NeroBot.modules import ALL_MODULES
import NeroBot.modules.sql.users_sql as sql
from NeroBot.modules.helper_funcs.chat_status import is_user_admin
from NeroBot.modules.helper_funcs.misc import paginate_modules
...
from NeroBot.modules.disable import DisableAbleCommandHandler
...
NERO_PHOTO = "https://telegra.ph/file/e1326143f0c924f13a13f.jpg"
...
DONATE_STRING = """Thanks For Your Support Though My Creator Doesn't Need Support Monetarily, Still Contact Him For More Info:- @dark_7_0 """
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("NeroBot.modules." + module_name)
...
async def awake(event):
  nero = event.sender.first_name
  nero = "**♡ I,m ɴᴇʀᴏ ʀᴏʙᴏᴛ 愛** \n\n"
  nero += "**♡ I'm Working With sᴇxʏ Speed**\n\n\n\n"
  nero += "**♡ ɴᴇʀᴏ: LATEST Version**\n\n**"
  nero += "**♡ My Creator:** [ᴹᴿ°᭄.Ꭰᥲʀκ͢☆Boy࿐ ❥≛](t.me/{OWNER_USERNAME})\n\n"
  nero += "****♡ ᴀɴʏ ɪssᴜᴇs ᴄᴏɴᴛᴀᴄᴛ ʜᴇʀᴇ @Nero_x_Support **\n\n"
  nero += "**♡ ᴛʜᴀɴᴋ ʏᴏᴜ ғᴏʀ ᴀᴅᴅɪɴɢ ᴍᴇ 💘💘💘**\n\n"
  NERO_BUTTON = [
      [
